...
const VideoHeaderReverse = ({video_text_normal, video_text_bold}) => {
  return (
    <div className="relative w-full h-[134px] overflow-hidden mx-auto md:max-w-[1920px]">
      <video 
        autoPlay 
        loop 
        muted 
...
export default VideoHeaderReverse;