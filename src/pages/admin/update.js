    ...
    <div className="flex flex-col min-h-screen bg-black text-white font-montserrat">
      ...
      <div className="flex-grow container mx-auto py-8">
        <nav className="mb-4 mt-4 ml-[-100px]">
          ...
          <span className="text-white text-[25.455px]">Update Product</span>
        </nav>

        <h1 className="font-kaushan text-[71px] mb-8 ml-[-100px]">Update Product</h1>
        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full md:w-1/2 px-4">
            <form className="w-full space-y-6">
              ...
              >
                <span className="group-hover:text-white transition-colors duration-300 ease-in-out">Update Product</span>
              </button>
            </form>
          </div>
        </div>
