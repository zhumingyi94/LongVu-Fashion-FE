...
<button className="group w-full border border-white text-white font-montserrat text-[22px] font-light flex items-center px-20 py-3 mb-4 transition-all duration-300 ease-in-out hover:bg-white">
